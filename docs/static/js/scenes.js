...
(function () {
  ...
  function build() {
    root.innerHTML = `
      ...
      <div class="scenes-lightbox" id="scenes-lightbox" hidden>
        <button class="scenes-lb-close" aria-label="Close">&times;</button>
        <button class="scenes-lb-arrow scenes-lb-prev" aria-label="Previous">&larr;</button>
        <div class="scenes-lb-stage">
          <img class="scenes-lb-img" alt="" />
          <div class="scenes-lb-meta"></div>
        </div>
        <button class="scenes-lb-arrow scenes-lb-next" aria-label="Next">&rarr;</button>
      </div>
    `;
  ...
  function setCategory(i) {
    ...
    tabs.forEach((b, j) => b.classList.toggle('is-active', j === i));
    renderGrid();
  }
  ...
  function closeLB() {
    root.querySelector('#scenes-lightbox').hidden = true;
